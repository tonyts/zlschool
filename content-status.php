	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<header class="entry-header">
			<hgroup>
				...
				<h3 class="entry-format"><?php _e( 'Status', 'zhilingschool' ); ?></h3>
			</hgroup>
		...
		<div class="entry-content">
			<div class="avatar"><?php echo get_avatar( get_the_author_meta( 'ID' ), apply_filters( 'zhilingschool_status_avatar', '65' ) ); ?></div>
