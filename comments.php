...
?>
	...
	<?php if ( have_comments() ) : ?>
		<h2 id="comments-title">
			<?php
				printf( _n( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'zhilingschool' ),
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use zhilingschool_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define zhilingschool_comment() and that will be used instead.
				 * See zhilingschool_comment() in zhilingschool/functions.php for more.
				 */
				wp_list_comments( array( 'callback' => 'zhilingschool_comment' ) );
			?>
		</ol>
